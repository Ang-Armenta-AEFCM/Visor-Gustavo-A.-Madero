...
function saveState() {
  if (!initialized) return;
  localStorage.setItem('visorStateV3:Visor_Gustavo_A_Madero', JSON.stringify({
...
function restoreState() {
  let state = {};
  try { state = JSON.parse(localStorage.getItem('visorStateV3:Visor_Gustavo_A_Madero') || '{}'); } catch {}
